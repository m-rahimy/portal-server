<?php
class Portal_junc_location_model extends CI_Model {
    ...
    */
    ...
    {
		$this->db->select('*');
		$this->db->from('portal_junc_location');
		$this->db->where('portal_id', $id);
		$query = $this->db->get();
		return $query->result_array();
    }

    public function get_by_lid($id)
    {
		$this->db->select('*');
		$this->db->from('portal_junc_location');
    ...
    */
    function store($data)
    {
      $this->db->set('id', 'UUID()', FALSE);
		$insert = $this->db->insert('portal_junc_location', $data);
	    return $insert;
	}
    ...
    */
    ...
    {
		$this->db->where('id', $id);
		$this->db->update('portal_junc_location', $data);
		$report = array();
    ...
    */
	function delete($id){
		$this->db->where('id', $id);
		$this->db->delete('portal_junc_location');
	}
