<?php
class Portal_location_model extends CI_Model {
    ...
    * @return array
    */
    public function get_by_lat_long_range($lat, $lon)
    {
		$this->db->select('*');
		$this->db->from('portal_location');
    ...
    */
    public function get_all($search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
		...
		if($search_string){
			$this->db->like('lat', $search_string);
		}
		$this->db->group_by('id');
    ...
    */
    function store($data)
    {
      $this->db->set('id', 'UUID()', FALSE);
		  $insert = $this->db->insert('portal_location', $data);
	    return $insert;
	}
    ...
    */
    ...
    {
		$this->db->where('id', $id);
		$this->db->update('portal_location', $data);
		$report = array();
    ...
    */
	function delete($id){
		$this->db->where('id', $id);
		$this->db->delete('portal_location');
	}
