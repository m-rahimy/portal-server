<?php
class Ingress_user_model extends CI_Model {
    ...
    */
    ...
    {
     return  $this->db->query("SELECT * FROM ingress_user"); // whatever you want to export to CSV, just select in query
    }
    /**
    ...
    */
    function store($data)    {
		  $insert = $this->db->insert('ingress_user', $data);
	    return $insert;
	  }
    ...
    */
    ...
    {
		$this->db->where('name', $id);
		$this->db->update('ingress_user', $data);
		$report = array();
