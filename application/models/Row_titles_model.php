<?php
class Row_titles_model extends CI_Model {
    ...
    */
    function store($data)
    {
		$insert = $this->db->insert('row_title', $data);
	    return $insert;
	}
