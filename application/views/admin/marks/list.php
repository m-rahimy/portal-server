          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="green header">نشان</th>
                <th class="green header">توضیحات</th>
            ...
            <tbody>
              ...
              foreach($marks as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/marks/update/'.$row['id'].'" class="btn btn-info">ویرایش</a>
                  <a href="'.site_url("admin").'/marks/delete/'.$row['id'].'" class="btn btn-danger">حذف</a>
                </td>';
                echo '</tr>';
              }
              ?>
