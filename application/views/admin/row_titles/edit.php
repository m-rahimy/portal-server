    <div class="container top">
      ...
      echo form_open('admin/row_titles/update/'.$this->uri->segment(4).'', $attributes);
      ?>
        <fieldset>
          <div class="control-group">
            <label for="inputError" class="control-label">نام</label>
            <div class="controls">
              <input type="text" id="" name="name" value="<?php echo $row_titles[0]['name']; ?>" >
          ...
          echo '<div class="control-group">';
            ...
            echo '<div class="controls">';
              ...
              echo form_dropdown('indicator_table_id', $options_category, $row_titles[0]['indicator_table_id'], 'class="span2"');
