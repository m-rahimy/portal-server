          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="green header">شماره و نام جدول مادر</th>
            ...
            <tbody>
              ...
              foreach($row_titles as $row)
              {
                ...
                echo '<td>'.$row['id'].'</td>';
                echo '<td>'.$row['name'].'</td>';
                echo '<td>'.$indicator_tables[$row['indicator_table_id']]['name'].' ('.$row['indicator_table_id'].")</td>";
                // echo '<td>'.$row['rowName'].'</td>';
                // echo '<td>'.$row['colName'].'</td>'; // todo: $row['col_title']['name'];
                // echo '<td>'.$row['amount'].'</td>';
                // echo '<td>'.$row['unitName'].'</td>';
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/row_titles/update/'.$row['id'].'" class="btn btn-info">ویرایش</a>
                  <a href="'.site_url("admin").'/row_titles/delete/'.$row['id'].'" class="btn btn-danger">حذف</a>
                </td>';
                echo '</tr>';
              }
              ?>
