      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            foreach ($indicator_tables as $array) {
            ...
            <tbody>
              ...
              foreach($indicator_tables as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/indicator_tables/update/'.$row['id'].'" class="btn btn-info">ویرایش</a>
                  <a href="'.site_url("admin").'/indicator_tables/delete/'.$row['id'].'" class="btn btn-danger">حذف</a>
                </td>';
                echo '</tr>';
              }
              ?>
